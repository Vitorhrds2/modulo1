...
var speed = 1.8 # velocidade, aumente esse valor para deixar o jogo mais difícil
var gravity = 1.8 # gravidade, aumente esse valor para deixar o jogo mais difícil
